...
{
    protected override void Write(SerializationWriter stream, Tuple<T1>? value, DataStyle style)
    {
...
{
    protected override void Write(SerializationWriter stream, Tuple<T1, T2>? value, DataStyle style)
    {
        stream.BeginSequence(DataStyle.Compact);
        stream.Write(value!.Item1, style);
...
{
    protected override void Write(SerializationWriter stream, Tuple<T1, T2, T3>? value, DataStyle style)
    {
        stream.BeginSequence(DataStyle.Compact);
        stream.Write(value!.Item1, style);
        stream.Write(value.Item2, style);
...
{
    protected override void Write(SerializationWriter stream, Tuple<T1, T2, T3, T4>? value, DataStyle style)
    {
        stream.BeginSequence(DataStyle.Compact);
        stream.Write(value!.Item1, style);
        stream.Write(value.Item2, style);
...
{
    protected override void Write(SerializationWriter stream, Tuple<T1, T2, T3, T4, T5>? value, DataStyle style)
    {
        stream.BeginSequence(DataStyle.Compact);
        stream.Write(value!.Item1, style);
        stream.Write(value.Item2, style);
...
{
    protected override void Write(SerializationWriter stream, Tuple<T1, T2, T3, T4, T5, T6>? value, DataStyle style)
    {
        stream.BeginSequence(DataStyle.Compact);
        stream.Write(value!.Item1, style);
        stream.Write(value.Item2, style);
...
{
    protected override void Write(SerializationWriter stream, Tuple<T1, T2, T3, T4, T5, T6, T7>? value, DataStyle style)
    {
        stream.BeginSequence(DataStyle.Compact);
        stream.Write(value!.Item1, style);
        stream.Write(value.Item2, style);
...
public class TupleFormatter<T1, T2, T3, T4, T5, T6, T7, T8> : YamlSerializer<Tuple<T1, T2, T3, T4, T5, T6, T7, T8>?>
    where T8 : notnull
{
    protected override void Write(SerializationWriter stream, Tuple<T1, T2, T3, T4, T5, T6, T7, T8>? value, DataStyle style)
    {
        stream.BeginSequence(DataStyle.Compact);
        stream.Write(value.Item1, style);
        stream.Write(value.Item2, style);
