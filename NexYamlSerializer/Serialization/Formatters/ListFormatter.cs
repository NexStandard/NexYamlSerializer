...
{
    protected override void Write(SerializationWriter stream, List<T>? value, DataStyle style)
    {
...
{
    public static void Serialize<T>(SerializationWriter stream, List<T> value, DataStyle style)
    {
