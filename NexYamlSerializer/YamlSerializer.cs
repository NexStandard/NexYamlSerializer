...
namespace NexVYaml
{
    ...
    public static class YamlSerializer
    {
        ...
        /// <summary>
        /// Asynchronously deserializes multiple YAML documents from the specified <paramref name="stream"/> to objects of type <typeparamref name="T"/>.
        /// </summary>
        /// <typeparam name="T">The type of the objects to be deserialized.</typeparam>
        /// <param name="stream">The Stream containing the YAML content with multiple documents to be deserialized.</param>
        /// <param name="options">Optional settings for customizing the YAML deserialization process.</param>
        /// <returns>A ValueTask representing the asynchronous operation, with the result being an IEnumerable of objects of type <typeparamref name="T"/> representing the deserialized YAML documents.</returns>
        [Obsolete("The state of this method's functionality is uncertain. Use alternative deserialization methods.")]
        ...
        /// <summary>
        /// Deserializes multiple YAML documents from the specified <paramref name="memory"/> to objects of type <typeparamref name="T"/>.
        /// </summary>
        /// <typeparam name="T">The type of the objects to be deserialized.</typeparam>
        /// <param name="memory">The ReadOnlyMemory containing the YAML content with multiple documents to be deserialized.</param>
        /// <param name="options">Optional settings for customizing the YAML deserialization process.</param>
        /// <returns>An IEnumerable of objects of type <typeparamref name="T"/> representing the deserialized YAML documents.</returns>
        [Obsolete("Unknown state if it's working or not.")]
