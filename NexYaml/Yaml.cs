...
public static class Yaml
{
    ...
    public static string Write<T>(T value, Writer writer, DataStyle style = DataStyle.Any)
    {
    ...
    {
        var writer = new Writer(NexYamlSerializerRegistry.Instance);
        return Write<T>(value, writer, style);
    }
